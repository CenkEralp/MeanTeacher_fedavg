...
args_torch = Arguments()

use_cuda = not args_torch.no_cuda and torch.cuda.is_available()

torch.manual_seed(args_torch.seed)
...
def main(args):
    ...
    train_loader = sy.FederatedDataLoader(dataset.federate((bob, alice)),
